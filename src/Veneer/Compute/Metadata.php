 ...
 */
namespace Google\ApiCore\Veneer\Compute;

use Google\ApiCore\Veneer\Compute\Metadata\Readers\HttpHandlerReader;
use Google\ApiCore\Veneer\Compute\Readers\ReaderInterface;
